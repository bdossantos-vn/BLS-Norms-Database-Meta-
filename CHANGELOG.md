...
- Reduced exported norm-chart category label size so percent metrics remain visually dominant.
...
- Polished exported native Excel charts for PowerPoint use with no chart title, no gridlines, larger labels, app colors, and editable chart data.
